...
let SafeGlobalBlob, safeGlobalFetch, SafeGlobalAbortController;
{
  SafeGlobalBlob = require('buffer').Blob;
  safeGlobalFetch = fetch || require('node-fetch');
  SafeGlobalAbortController = AbortController || require('abort-controller');
}
