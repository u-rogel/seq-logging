"use strict";
var SafeGlobalBlob, safeGlobalFetch, SafeGlobalAbortController
if (IS_BROWSER) {
  SafeGlobalBlob =  Blob;
  safeGlobalFetch = fetch;
  SafeGlobalAbortController = AbortController;
} else {
  SafeGlobalBlob = require('buffer').Blob
  safeGlobalFetch = require('node-fetch')
  SafeGlobalAbortController = require('abort-controller')
}
